# Generated by Django 4.2.4 on 2023-10-02 17:46
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Faculty', '0008_alter_kcseresults_grade_alter_kcseresults_subject_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='grade',
            field=models.CharField(choices=[('B-', 'B-'), ('C', 'C'), ('B+', 'B+'), ('A-', 'A-'), ('D', 'D'), ('D-', 'D-'), ('C+', 'C+'), ('B', 'B'), ('E', 'E'), ('D+', 'D+'), ('C-', 'C-'), ('A', 'A')], max_length=100),
        ),
        migrations.AlterField(
            model_name='kcseresults',
            name='subject',
            field=models.CharField(choices=[('Chemistry', 'Chemistry'), ('Computer Studies', 'Computer Studies'), ('Business Studies', 'Business Studies'), ('Kiswahili', 'Kiswahili'), ('French', 'French'), ('Agriculture', 'Agriculture'), ('Building and Construction', 'Building and Construction'), ('Biology', 'Biology'), ('Drawing and Design', 'Drawing and Design'), ('Home Science', 'Home Science'), ('English', 'English'), ('Mathematics', 'Mathematics'), ('Physics', 'Physics'), ('Geography', 'Geography'), ('Christian Religious Education', 'Christian Religious Education')], max_length=100),
        ),
        migrations.AlterField(
            model_name='lecturerevaluation',
            name='answers_questions_clearly',
            field=models.CharField(choices=[('3', 'Adequate'), ('5', 'Excellent'), ('2', 'Poor'), ('1', 'Too Much'), ('4', 'Good')], max_length=100),
        ),
        migrations.AlterField(
            model_name='lecturerevaluation',
        ...
        migrations.AlterField(
            ...
            name='addressed_to',
            field=models.CharField(choices=[('STUDENT', 'STUDENT'), ('DEAN', 'DEAN'), ('HOD', 'HOD'), ('LEC', 'LEC'), ('ADMIN', 'ADMIN'), ('FINANCE', 'FINANCE')], default='STUDENT', max_length=100),
        ),
    ]
