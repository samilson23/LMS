# Generated by Django 4.2.4 on 2024-02-25 05:28
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Faculty', '0023_remove_year_stage_alter_kcseresults_grade_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='grade',
            field=models.CharField(choices=[('D-', 'D-'), ('C+', 'C+'), ('A', 'A'), ('D+', 'D+'), ('B', 'B'), ('E', 'E'), ('C', 'C'), ('C-', 'C-'), ('A-', 'A-'), ('B+', 'B+'), ('D', 'D'), ('B-', 'B-')], max_length=100),
        ),
        migrations.AlterField(
            model_name='kcseresults',
            name='subject',
            field=models.CharField(choices=[('Computer Studies', 'Computer Studies'), ('Building and Construction', 'Building and Construction'), ('English', 'English'), ('Biology', 'Biology'), ('Geography', 'Geography'), ('French', 'French'), ('Christian Religious Education', 'Christian Religious Education'), ('Physics', 'Physics'), ('Agriculture', 'Agriculture'), ('Business Studies', 'Business Studies'), ('Chemistry', 'Chemistry'), ('Home Science', 'Home Science'), ('Kiswahili', 'Kiswahili'), ('Drawing and Design', 'Drawing and Design'), ('Mathematics', 'Mathematics')], max_length=100),
        ),
        migrations.AlterField(
            model_name='lecturerevaluation',
            name='answers_questions_clearly',
            field=models.CharField(choices=[('Too Much', 'Too Much'), ('Good', 'Good'), ('Adequate', 'Adequate'), ('Excellent', 'Excellent'), ('Poor', 'Poor')], max_length=100),
        ),
        migrations.AlterField(
            model_name='lecturerevaluation',
        ...
        migrations.AlterField(
            ...
            name='addressed_to',
            field=models.CharField(choices=[('FINANCE', 'FINANCE'), ('STUDENT', 'STUDENT'), ('ADMIN', 'ADMIN'), ('DEAN', 'DEAN'), ('LEC', 'LEC'), ('HOD', 'HOD')], default='STUDENT', max_length=100),
        ),
        migrations.AlterField(
            model_name='noticeboard',
            name='notice',
