...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='grade',
            field=models.CharField(choices=[('B-', 'B-'), ('B+', 'B+'), ('A', 'A'), ('C-', 'C-'), ('D+', 'D+'), ('B', 'B'), ('C', 'C'), ('A-', 'A-'), ('D-', 'D-'), ('D', 'D'), ('C+', 'C+'), ('E', 'E')], max_length=100),
        ),
        migrations.AlterField(
            model_name='kcseresults',
            name='subject',
            field=models.CharField(choices=[('Computer Studies', 'Computer Studies'), ('Building and Construction', 'Building and Construction'), ('English', 'English'), ('Agriculture', 'Agriculture'), ('Biology', 'Biology'), ('Chemistry', 'Chemistry'), ('Christian Religious Education', 'Christian Religious Education'), ('Geography', 'Geography'), ('Drawing and Design', 'Drawing and Design'), ('Home Science', 'Home Science'), ('Business Studies', 'Business Studies'), ('Physics', 'Physics'), ('Kiswahili', 'Kiswahili'), ('French', 'French'), ('Mathematics', 'Mathematics')], max_length=100),
        ),
        migrations.AlterField(
            model_name='lecturerevaluation',
            name='answers_questions_clearly',
            field=models.CharField(choices=[('Excellent', 'Excellent'), ('Too Much', 'Too Much'), ('Good', 'Good'), ('Poor', 'Poor'), ('Adequate', 'Adequate')], max_length=100),
        ),
        migrations.AlterField(
            model_name='lecturerevaluation',
        ...
        migrations.AlterField(
            ...
            name='addressed_to',
            field=models.CharField(choices=[('STUDENT', 'STUDENT'), ('ADMIN', 'ADMIN'), ('DEAN', 'DEAN'), ('FINANCE', 'FINANCE'), ('HOD', 'HOD'), ('LEC', 'LEC')], default='STUDENT', max_length=100),
        ),
    ]
