...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='grade',
            field=models.CharField(choices=[('A', 'A'), ('B-', 'B-'), ('E', 'E'), ('D', 'D'), ('C+', 'C+'), ('C', 'C'), ('D+', 'D+'), ('C-', 'C-'), ('B', 'B'), ('A-', 'A-'), ('D-', 'D-'), ('B+', 'B+')], max_length=100),
        ),
        migrations.AlterField(
            model_name='kcseresults',
            name='subject',
            field=models.CharField(choices=[('Kiswahili', 'Kiswahili'), ('Biology', 'Biology'), ('Physics', 'Physics'), ('Geography', 'Geography'), ('Drawing and Design', 'Drawing and Design'), ('Computer Studies', 'Computer Studies'), ('Home Science', 'Home Science'), ('Business Studies', 'Business Studies'), ('Mathematics', 'Mathematics'), ('Building and Construction', 'Building and Construction'), ('French', 'French'), ('Chemistry', 'Chemistry'), ('Agriculture', 'Agriculture'), ('English', 'English'), ('Christian Religious Education', 'Christian Religious Education')], max_length=100),
        ),
        migrations.AlterField(
            model_name='lecturerevaluation',
            name='answers_questions_clearly',
            field=models.CharField(choices=[('Adequate', 'Adequate'), ('Excellent', 'Excellent'), ('Too Much', 'Too Much'), ('Good', 'Good'), ('Poor', 'Poor')], max_length=100),
        ),
        migrations.AlterField(
            model_name='lecturerevaluation',
        ...
        migrations.AlterField(
            ...
            name='addressed_to',
            field=models.CharField(choices=[('STUDENT', 'STUDENT'), ('HOD', 'HOD'), ('ADMIN', 'ADMIN'), ('FINANCE', 'FINANCE'), ('DEAN', 'DEAN'), ('LEC', 'LEC')], default='STUDENT', max_length=100),
        ),
    ]
