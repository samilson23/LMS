# Generated by Django 4.2.4 on 2024-02-25 05:31
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Faculty', '0024_alter_kcseresults_grade_alter_kcseresults_subject_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='grade',
            field=models.CharField(choices=[('D', 'D'), ('E', 'E'), ('B', 'B'), ('D+', 'D+'), ('D-', 'D-'), ('A', 'A'), ('B-', 'B-'), ('A-', 'A-'), ('C+', 'C+'), ('C-', 'C-'), ('B+', 'B+'), ('C', 'C')], max_length=100),
        ),
        migrations.AlterField(
            model_name='kcseresults',
            name='subject',
            field=models.CharField(choices=[('Christian Religious Education', 'Christian Religious Education'), ('Home Science', 'Home Science'), ('Drawing and Design', 'Drawing and Design'), ('Biology', 'Biology'), ('Business Studies', 'Business Studies'), ('English', 'English'), ('Kiswahili', 'Kiswahili'), ('Physics', 'Physics'), ('French', 'French'), ('Chemistry', 'Chemistry'), ('Building and Construction', 'Building and Construction'), ('Geography', 'Geography'), ('Agriculture', 'Agriculture'), ('Computer Studies', 'Computer Studies'), ('Mathematics', 'Mathematics')], max_length=100),
        ),
        migrations.AlterField(
            model_name='lecturerevaluation',
            name='answers_questions_clearly',
            field=models.CharField(choices=[('Excellent', 'Excellent'), ('Poor', 'Poor'), ('Adequate', 'Adequate'), ('Too Much', 'Too Much'), ('Good', 'Good')], max_length=100),
        ),
        migrations.AlterField(
            model_name='lecturerevaluation',
        ...
        migrations.AlterField(
            ...
            name='addressed_to',
            field=models.CharField(choices=[('DEAN', 'DEAN'), ('FINANCE', 'FINANCE'), ('HOD', 'HOD'), ('LEC', 'LEC'), ('ADMIN', 'ADMIN'), ('STUDENT', 'STUDENT')], default='STUDENT', max_length=100),
        ),
        migrations.AlterField(
            model_name='noticeboard',
            name='notice',
