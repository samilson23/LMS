...
from Head_of_department.models import HOD, CHOICES

User = get_user_model()


class CreateHODProfile(forms.ModelForm):
...
class HODProfilePicture(forms.ModelForm):
    class Meta:
        model = User
        fields = [
            'profile_pic',
...
class HODDetails(forms.ModelForm):
